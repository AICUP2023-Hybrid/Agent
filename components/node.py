...
class Node:
    ...
    def save_version(self):
        self.saved.append([self.owner, self.number_of_troops, self.number_of_fort_troops])

    def restore_version(self):
        if len(self.saved) > 0:
            self.owner, self.number_of_troops, self.number_of_fort_troops = self.saved.pop()
