...
class Game:
    ...
    def get_owners(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_owners',
    ...
    def get_number_of_troops(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_troops_count',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
    ...
    def get_state(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_state',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
    ...
    def get_turn_number(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_turn_number',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
    ...
    def get_adj(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_adj',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
    ...
    def next_state(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/next_state',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
    ...
    def put_one_troop(self, node_id):
        ...
        try:
            resp = requests.request('POST', f'http://{self.server_ip}:{self.server_port}/put_one_troop',
                                    headers={'x-access-token': self.token}, data=body)
        except:
            print("can't make request")
            return {}
        return self.handel_output(resp)
    ...
    def put_troop(self, node_id, num):
        ...
        try:
            resp = requests.request('POST', f'http://{self.server_ip}:{self.server_port}/put_troop',
                                    headers={'x-access-token': self.token}, data=body)
        except:
            print("can't make request")
            return {}
    ...
    def get_player_id(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_player_id',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
        return self.handel_output(resp)['player_id']
    ...
    def attack(self, attacking_id, target_id, fraction, move_fraction):
        ...
        try:
            resp = requests.request('POST', f'http://{self.server_ip}:{self.server_port}/attack',
                                    headers={'x-access-token': self.token}, data=body)
        except:
            print("can't make request")
            return {}
    ...
    def move_troop(self, source, destination, troop_count):
        ...
        try:
            resp = requests.request('POST', f'http://{self.server_ip}:{self.server_port}/move_troop',
                                    headers={'x-access-token': self.token}, data=body)
        except:
            print("can't make request")
            return {}
    ...
    def get_strategic_nodes(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_strategic_nodes',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
    ...
    def get_number_of_troops_to_put(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_number_of_troops_to_put',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
    ...
    def get_reachable(self, node_id):
        ...
        try:
            resp = requests.request('POST', f'http://{self.server_ip}:{self.server_port}/get_reachable',
                                    headers={'x-access-token': self.token}, data=body)
        except:
            print("can't make request")
            return {}
    ...
    def get_number_of_fort_troops(self):
        ...
        """
        try:
            resp = requests.request('GET', f'http://{self.server_ip}:{self.server_port}/get_number_of_fort_troops',
                                    headers={'x-access-token': self.token})
        except:
            print("can't make request")
            return
    ...
    def fort(self, node_id, troop_count):
        ...
        try:
            resp = requests.request('POST', f'http://{self.server_ip}:{self.server_port}/fort',
                                    headers={'x-access-token': self.token}, data=body)
        except:
            print("can't make request")
            return {}
